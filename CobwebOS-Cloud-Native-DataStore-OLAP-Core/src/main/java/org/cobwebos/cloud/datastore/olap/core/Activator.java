 ...
 */
package org.cobwebos.cloud.datastore.olap.core;

import java.io.File;

import org.cobwebos.cloud.datastore.olap.core.utils.CliUtil;
import org.cobwebos.cloud.datastore.olap.core.utils.CobwebosUtils;
...
public class Activator implements BundleActivator {
	...
	public void doStop() {
		...
		String command = CobwebosUtils.getInstance().getCobwebosRootDir() + "bin" + File.separator
				+ "stop-cobwebos-olap.sh";
		if (CobwebosUtils.getInstance().isWindows()) {
			command = CobwebosUtils.getInstance().getCobwebosRootDir() + "bin" + File.separator + "stop-cobwebos-olap.bat";
		}
		log.info("getCobwebosRootDir:" + CobwebosUtils.getInstance().getCobwebosRootDir());
		log.info("command:" + command);
		CliUtil cli = new CliUtil();
